                ...
                <div className="content col-md-offset-6 col-lg-offset-6">
                  ...
                  <div className="shortDesc">
                    <h2 class="text-blk subHeading">
                      ...
                      hiring talented freelancers. Our team at Flexihire
                      consists of two passionate individuals dedicated to
                      connecting skilled freelancers with clients who need their
                      expertise.
                      <br />
                      <br />
