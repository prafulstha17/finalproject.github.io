                ...
                <div class="container">
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="about-content col-lg-12">
                            ...
                            <p class="text-white link-nav"><a href="#">About</a>  <i class="fa-solid fa-arrow-right"> </i><a href="#">Why Us?</a></p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-3 no-padding feat-txt">
                            ...
                            <p>
                                We are a duo of individuals who are collaborating on the development of a website with an intuitive and user-friendly interface.
                            </p>
                        </div>
                        <div class="col-lg-3 no-padding feat-txt">
                            <h6 class="text-uppercase text-white">What we do</h6>
                            <p>
                                We connect job seekers with top employers and provide tools and resources to help you succeed.
                            </p>
                        </div>
                    </div>
                </div>
